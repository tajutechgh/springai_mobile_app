...
class BaseUrl {
  ...
  static const String _defaultBase = "https://tajutecgh.com";
  ...
  static String getPrepareRecipeModel(String ingredients, String cuisine, String dietaryRestrictions) => "$base/tajutechgh/ai/v1/get/recipe?ingredients=$ingredients&cuisine=$cuisine&dietaryRestrictions=$dietaryRestrictions";
}
